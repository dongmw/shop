(function(f){"function"===typeof require&&"object"===typeof exports&&"object"===typeof module?module.exports=f:"function"===typeof define?define.amd||define(["jquery"],f):window.editormd=f()})(function(){var f="undefined"!==typeof jQuery?jQuery:Zepto;if("undefined"!==typeof f){var e=function(a,b){return new e.fn.init(a,b)};e.title=e.$name="Editor.md";e.version="1.5.0";e.homePage="https://pandao.github.io/editor.md/";e.classPrefix="editormd-";e.toolbarModes={full:"undo redo | bold del italic quote ucwords uppercase lowercase | h1 h2 h3 h4 h5 h6 | list-ul list-ol hr | link reference-link image code preformatted-text code-block table datetime emoji html-entities pagebreak | goto-line watch preview fullscreen clear search | help info".split(" "),
    simple:"undo redo | bold del italic quote uppercase lowercase | h1 h2 h3 h4 h5 h6 | list-ul list-ol hr | watch preview fullscreen | help info".split(" "),mini:"undo redo | watch preview | help info".split(" ")};e.defaults={mode:"gfm",name:"",value:"",theme:"",editorTheme:"default",previewTheme:"",markdown:"",appendMarkdown:"",width:"100%",height:"100%",path:"./lib/",pluginPath:"",delay:300,autoLoadModules:!0,watch:!0,placeholder:"Enjoy Markdown! coding now...",gotoLine:!0,codeFold:!1,autoHeight:!1,
...
(e.$CodeMirror=CodeMirror),"undefined"!==typeof marked&&(e.$marked=marked),this.setCodeMirror().setToolbar().loadedDisplay()):this.loadQueues();return this},loadQueues:function(){var a=this,b=this.settings,c=b.path,d=function(){e.isIE8?a.loadedDisplay():b.flowChart||b.sequenceDiagram?e.loadScript(c+"raphael.min",function(){e.loadScript(c+"underscore.min",function(){!b.flowChart&&b.sequenceDiagram?e.loadScript(c+"sequence-diagram.min",function(){a.loadedDisplay()}):b.flowChart&&!b.sequenceDiagram?
    ...
    this.settings;if(!b.gotoLine)return this;var c=this.cm,d=c.lineCount(),e=this.preview;"string"===typeof a&&("last"===a&&(a=d),"first"===a&&(a=1));if("number"!==typeof a)return alert("Error: The line number must be an integer."),this;a=parseInt(a)-1;if(a>d)return alert("Error: The line number range 1-"+d),this;c.setCursor({line:a,ch:0});d=c.getScrollInfo().clientHeight;a=c.charCoords({line:a,ch:0},"local");c.scrollTo(null,(a.top+a.bottom-d)/2);if(b.watch){b=this.codeMirror.find(".CodeMirror-scroll")[0];
    a=f(b).height();var d=b.scrollTop,l=d/b.scrollHeight;0===d?e.scrollTop(0):d+a>=b.scrollHeight-16?e.scrollTop(e[0].scrollHeight):e.scrollTop(e[0].scrollHeight*l)}c.focus();return this},extend:function(a,b){"undefined"!==typeof b&&("function"===typeof b&&(b=f.proxy(b,this)),this[a]=b);"object"===typeof a&&"undefined"===typeof a.length&&f.extend(!0,this,a);return this},set:function(a,b){"undefined"!==typeof b&&"function"===typeof b&&(b=f.proxy(b,this));this[a]=b;return this},config:function(a,b){var c=
...
this.setToolbar();b.toolbar=!0;this.toolbar.show();this.resize();f.proxy(a||function(){},this)();return this},hideToolbar:function(a){this.settings.toolbar=!1;this.toolbar.hide();this.resize();f.proxy(a||function(){},this)();return this},setToolbarAutoFixed:function(a){var b=this.state,c=this.editor,d=this.toolbar,e=this.settings;"undefined"!==typeof a&&(e.toolbarAutoFixed=a);a=function(){var a=f(window),b=a.scrollTop();if(!e.toolbarAutoFixed)return!1;10<b-c.offset().top&&b<c.height()?d.css({position:"fixed",
    ...
    var c=this.cm,d=this.toolbarIcons=this.toolbar.find("."+this.classPrefix+"menu > li > a"),k=this.getToolbarHandles();d.bind(e.mouseOrTouch("click","touchend"),function(d){d=f(this).children(".fa");var e=d.attr("name"),h=c.getCursor(),m=c.getSelection();if(""!==e)return a.activeIcon=d,"undefined"!==typeof k[e]?f.proxy(k[e],a)(c):"undefined"!==typeof b.toolbarHandlers[e]&&f.proxy(b.toolbarHandlers[e],a)(c,d,h,m),"link"!==e&&"reference-link"!==e&&"image"!==e&&"code-block"!==e&&"preformatted-text"!==
...
e.homePage+'" target="_blank">'+e.homePage+' <i class="fa fa-external-link"></i></a></p>','<p style="font-size: 0.85em;">Copyright &copy; 2015 <a href="https://github.com/pandao" target="_blank" class="hover-link">Pandao</a>, The <a href="https://github.com/pandao/editor.md/blob/master/LICENSE" target="_blank" class="hover-link">MIT</a> License.</p>\n</div>','<a href="javascript:;" class="fa fa-close '+c+'dialog-close"></a>',"</div>"].join("\n");b.append(d);b=this.infoDialog=b.children("."+c+"dialog-info");
    ...
    d=b.scrollTop(),k=d/b[0].scrollHeight,l=0;a.find(".markdown-toc-list").each(function(){l+=f(this).height()});var g=a.find(".editormd-toc-menu").height(),g=g?g:0;0===d?a.scrollTop(0):d+c>=b[0].scrollHeight-16?a.scrollTop(a[0].scrollHeight):a.scrollTop((a[0].scrollHeight+l+g)*k);return this},registerKeyMaps:function(a){var b=this,c=this.cm,d=e.toolbarHandlers,k=this.settings.disabledKeyMaps;if(a=a||null)for(var l in a)0>f.inArray(l,k)&&c.addKeyMap(a);else{for(var g in e.keyMaps)a=e.keyMaps[g],a="string"===
typeof a?f.proxy(d[a],b):f.proxy(a,b),0>f.inArray(g,["F9","F10","F11"])&&0>f.inArray(g,k)&&(l={},l[g]=a,c.addKeyMap(l));f(window).keydown(function(a){if(0>f.inArray({120:"F9",121:"F10",122:"F11"}[a.keyCode],k))switch(a.keyCode){case 120:return f.proxy(d.watch,b)(),!1;case 121:return f.proxy(d.preview,b)(),!1;case 122:return f.proxy(d.fullscreen,b)(),!1}})}return this},bindScrollEvent:function(){var a=this,b=this.preview,c=this.settings,d=this.codeMirror,k=e.mouseOrTouch;if(!c.syncScrolling)return this;
    var l=function(){d.find(".CodeMirror-scroll").bind(k("scroll","touchmove"),function(d){var e=f(this).height(),k=f(this).scrollTop(),g=k/f(this)[0].scrollHeight,h=0;b.find(".markdown-toc-list").each(function(){h+=f(this).height()});var v=b.find(".editormd-toc-menu").height(),v=v?v:0;0===k?b.scrollTop(0):k+e>=f(this)[0].scrollHeight-16?b.scrollTop(b[0].scrollHeight):b.scrollTop((b[0].scrollHeight+h+v)*g);f.proxy(c.onscroll,a)(d)})},g=function(){d.find(".CodeMirror-scroll").unbind(k("scroll","touchmove"))},
        h=function(){b.bind(k("scroll","touchmove"),function(b){var e=f(this).height(),k=f(this).scrollTop(),g=k/f(this)[0].scrollHeight,h=d.find(".CodeMirror-scroll");0===k?h.scrollTop(0):k+e>=f(this)[0].scrollHeight?h.scrollTop(h[0].scrollHeight):h.scrollTop(h[0].scrollHeight*g);f.proxy(c.onpreviewscroll,a)(b)})},m=function(){b.unbind(k("scroll","touchmove"))};d.bind({mouseover:l,mouseout:g,touchstart:l,touchend:g});if("single"===c.syncScrolling)return this;b.bind({mouseover:h,mouseout:m,touchstart:h,touchend:m});
    ...
    this.resize();this.registerKeyMaps();f(window).resize(function(){b.resize()});this.bindScrollEvent().bindChangeEvent();a||f.proxy(e.onload,this)();this.state.loaded=!0;return this},width:function(a){this.editor.css("width","number"===typeof a?a+"px":a);this.resize();return this},height:function(a){this.editor.css("height","number"===typeof a?a+"px":a);this.resize();return this},resize:function(a,b){a=a||null;b=b||null;var c=this.state,d=this.editor,e=this.preview,l=this.toolbar,g=this.settings,h=
    this.codeMirror;a&&d.css("width","number"===typeof a?a+"px":a);!g.autoHeight||c.fullscreen||c.preview?(b&&d.css("height","number"===typeof b?b+"px":b),c.fullscreen&&d.height(f(window).height()),g.toolbar&&!g.readOnly?h.css("margin-top",l.height()+1).height(d.height()-l.height()):h.css("margin-top",0).height(d.height())):(d.css("height","auto"),h.css("height","auto"));g.watch?(h.width(d.width()/2),e.width(c.preview?d.width():d.width()/2),this.previewContainer.css("padding",g.autoHeight?"20px 20px 50px 40px":
    "20px"),g.toolbar&&!g.readOnly?e.css("top",l.height()+1):e.css("top",0),!g.autoHeight||c.fullscreen||c.preview?(d=g.toolbar&&!g.readOnly?d.height()-l.height():d.height(),e.height(d)):e.height("")):(h.width(d.width()),e.hide());c.loaded&&f.proxy(g.onresize,this)();return this},save:function(){if(null===u)return this;var a=this,b=this.state,c=this.settings,d=this.cm,k=d.getValue(),l=this.previewContainer;if("gfm"!==c.mode&&"markdown"!==c.mode)return this.markdownTextarea.val(k),this;var g=e.$marked,
    h=this.markdownToC=[],m=this.markedRendererOptions={toc:c.toc,tocm:c.tocm,tocStartLevel:c.tocStartLevel,pageBreak:c.pageBreak,taskList:c.taskList,emoji:c.emoji,tex:c.tex,atLink:c.atLink,emailLink:c.emailLink,flowChart:c.flowChart,sequenceDiagram:c.sequenceDiagram,previewCodeHighlight:c.previewCodeHighlight},m=this.markedOptions={renderer:e.markedRenderer(h,m),gfm:!0,tables:!0,breaks:!0,pedantic:!1,sanitize:c.htmlDecode?!1:!0,smartLists:!0,smartypants:!0};g.setOptions(m);g=e.$marked(k,m);g=e.filterHTMLTags(g,
    c.htmlDecode);this.markdownTextarea.text(k);d.save();c.saveHTMLToTextarea&&this.htmlTextarea.text(g);if(c.watch||!c.watch&&b.preview){l.html(g);this.previewCodeHighlight();c.toc&&(d=""===c.tocContainer?l:f(c.tocContainer),k=d.find("."+this.classPrefix+"toc-menu"),d.attr("previewContainer",""===c.tocContainer?"true":"false"),""!==c.tocContainer&&0<k.length&&k.remove(),e.markdownToCRenderer(h,d,c.tocDropdown,c.tocStartLevel),(c.tocDropdown||0<d.find("."+this.classPrefix+"toc-menu").length)&&e.tocDropdownMenu(d,
    ""!==c.tocTitle?c.tocTitle:this.lang.tocTitle),""!==c.tocContainer&&l.find(".markdown-toc").css("border","none"));c.tex&&(!e.kaTeXLoaded&&c.autoLoadModules?e.loadKaTeX(function(){e.$katex=katex;e.kaTeXLoaded=!0;a.katexRender()}):(e.$katex=katex,this.katexRender()));if(c.flowChart||c.sequenceDiagram)w=setTimeout(function(){clearTimeout(w);a.flowChartAndSequenceDiagramRender();w=null},10);b.loaded&&f.proxy(c.onchange,this)()}return this},focus:function(){this.cm.focus();return this},setCursor:function(a){this.cm.setCursor(a);
    ...
    this.previewContainer.html():(alert("Error: settings.watch == false"),!1)},watch:function(a){var b=this.settings;if(0>f.inArray(b.mode,["gfm","markdown"]))return this;this.state.watching=b.watch=!0;this.preview.show();if(this.toolbar){var c=b.toolbarIconsClass.watch,d=b.toolbarIconsClass.unwatch,e=this.toolbar.find(".fa[name=watch]");e.parent().attr("title",b.lang.toolbar.watch);e.removeClass(d).addClass(c)}this.codeMirror.css("border-right","1px solid #ddd").width(this.editor.width()/2);u=0;this.save().resize();
    b.onwatch||(b.onwatch=a||function(){});f.proxy(b.onwatch,this)();return this},unwatch:function(a){var b=this.settings;this.state.watching=b.watch=!1;this.preview.hide();if(this.toolbar){var c=b.toolbarIconsClass.watch,d=b.toolbarIconsClass.unwatch,e=this.toolbar.find(".fa[name=watch]");e.parent().attr("title",b.lang.toolbar.unwatch);e.removeClass(c).addClass(d)}this.codeMirror.css("border-right","none").width(this.editor.width());this.resize();b.onunwatch||(b.onunwatch=a||function(){});f.proxy(b.onunwatch,
    this)();return this},show:function(a){a=a||function(){};var b=this;this.editor.show(0,function(){f.proxy(a,b)()});return this},hide:function(a){a=a||function(){};var b=this;this.editor.hide(0,function(){f.proxy(a,b)()});return this},previewing:function(){var a=this,b=this.editor,c=this.preview,d=this.toolbar,k=this.settings,l=this.codeMirror,g=this.previewContainer;if(0>f.inArray(k.mode,["gfm","markdown"]))return this;k.toolbar&&d&&(d.toggle(),d.find(".fa[name=preview]").toggleClass("active"));l.toggle();
    d=function(b){b.shiftKey&&27===b.keyCode&&a.previewed()};"none"===l.css("display")?(this.state.preview=!0,this.state.fullscreen&&c.css("background","#fff"),b.find("."+this.classPrefix+"preview-close-btn").show().bind(e.mouseOrTouch("click","touchend"),function(){a.previewed()}),k.watch?g.css("padding",""):this.save(),g.addClass(this.classPrefix+"preview-active"),c.show().css({position:"",top:0,width:b.width(),height:k.autoHeight&&!this.state.fullscreen?"auto":b.height()}),this.state.loaded&&f.proxy(k.onpreviewing,
...
a.width())/2+"px"});c.dialogShowMask&&b.children("."+this.classPrefix+"mask").css("z-index",parseInt(a.css("z-index"))-1).show()};e.toolbarHandlers={undo:function(){this.cm.undo()},redo:function(){this.cm.redo()},bold:function(){var a=this.cm,b=a.getCursor(),c=a.getSelection();a.replaceSelection("**"+c+"**");""===c&&a.setCursor(b.line,b.ch+2)},del:function(){var a=this.cm,b=a.getCursor(),c=a.getSelection();a.replaceSelection("~~"+c+"~~");""===c&&a.setCursor(b.line,b.ch+2)},italic:function(){var a=
    ...
    function(a){return a.toUpperCase()})};e.firstUpperCase=e.ucfirst=function(a){return a.toLowerCase().replace(/\b(\w)/,function(a){return a.toUpperCase()})};e.urls={atLinkBase:"https://github.com/"};e.regexs={atLink:/@(\w+)/g,email:/(\w+)@(\w+)\.(\w+)\.?(\w+)?/g,emailLink:/(mailto:)?([\w\.\_]+)@(\w+)\.(\w+)\.?(\w+)?/g,emoji:/:([\w\+-]+):/g,emojiDatetime:/(\d{2}:\d{2}:\d{2})/g,twemoji:/:(tw-([\w]+)-?(\w+)?):/g,fontAwesome:/:(fa-([\w]+)(-(\w+)){0,}):/g,editormdLogo:/:(editormd-logo-?(\w+)?):/g,pageBreak:/^\[[=]{8,}\]$/};
    e.emoji={path:"http://www.emoji-cheat-sheet.com/graphics/emojis/",ext:".png"};e.twemoji={path:"http://twemoji.maxcdn.com/36x36/",ext:".png"};e.markedRenderer=function(a,b){var c=f.extend({toc:!0,tocm:!1,tocStartLevel:1,pageBreak:!0,atLink:!0,emailLink:!0,taskList:!1,emoji:!1,tex:!1,flowChart:!1,sequenceDiagram:!1},b||{}),d=e.$marked,k=new d.Renderer;a=a||[];var l=e.regexs,g=l.atLink,h=l.emoji,m=l.email,p=l.emailLink,r=l.twemoji,n=l.fontAwesome,q=l.editormdLogo,t=l.pageBreak;k.emoji=function(a){a=
        a.replace(e.regexs.emojiDatetime,function(a){return a.replace(/:/g,"&#58;")});var b=a.match(h);if(!b||!c.emoji)return a;for(var d=0,f=b.length;d<f;d++)":+1:"===b[d]&&(b[d]=":\\+1:"),a=a.replace(new RegExp(b[d]),function(a,b){var c=a.match(n),d=a.replace(/:/g,"");if(c)for(d=c.length;0<d;)return d=c[0].replace(/:/g,""),'<i class="fa '+d+' fa-emoji" title="'+d.replace("fa-","")+'"></i>';else{var c=a.match(q),f=a.match(r);if(c)for(d=c.length;0<d;)return d=c[0].replace(/:/g,""),'<i class="'+d+'" title="Editor.md logo ('+
    d+')"></i>';else if(f)for(d=f.length;0<d;)return d=f[0].replace(/:/g,"").replace("tw-",""),'<img src="'+e.twemoji.path+d+e.twemoji.ext+'" title="twemoji-'+d+'" alt="twemoji-'+d+'" class="emoji twemoji" />';else return c="+1"===d?"plus1":d,c="black_large_square"===c?"black_square":c,'<img src="'+e.emoji.path+("moon"===c?"waxing_gibbous_moon":c)+e.emoji.ext+'" class="emoji" title="&#58;'+d+'&#58;" alt="&#58;'+d+'&#58;" />'}});return a};k.atLink=function(a){g.test(a)&&(c.atLink&&(a=a.replace(m,function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             b,c,d){return a.replace(/@/g,"_#_&#64;_#_")}),a=a.replace(g,function(a,b){return'<a href="'+e.urls.atLinkBase+""+b+'" title="&#64;'+b+'" class="at-link">'+a+"</a>"}).replace(/_#_&#64;_#_/g,"@")),c.emailLink&&(a=a.replace(p,function(a,b,c,d,e){return!b&&0>f.inArray(e,"jpg jpeg png gif webp ico icon pdf".split(" "))?'<a href="mailto:'+a+'">'+a+"</a>":a})));return a};k.link=function(a,b,c){if(this.options.sanitize){try{var d=decodeURIComponent(unescape(a)).replace(/[^\w:]/g,"").toLowerCase()}catch(e){return""}if(0===
        d.indexOf("javascript:"))return""}a='<a href="'+a+'"';if(g.test(b)||g.test(c))return b&&(a+=' title="'+b.replace(/@/g,"&#64;")),a+'">'+c.replace(/@/g,"&#64;")+"</a>";b&&(a+=' title="'+b+'"');return a+(">"+c+"</a>")};k.heading=function(b,c,d){d=b;var e=/\s*\<a\s*href\=\"(.*)\"\s*([^\>]*)\>(.*)\<\/a\>\s*/;if(e.test(b)){var f=[];b=b.split(/\<a\s*([^\>]+)\>([^\>]*)\<\/a\>/);for(var k=0,h=b.length;k<h;k++)f.push(b[k].replace(/\s*href\=\"(.*)\"\s*/g,""));b=f.join(" ")}b=x(b);f=b.toLowerCase().replace(/[^\w]+/g,
        "-");f={text:b,level:c,slug:f};k=/^[\u4e00-\u9fa5]+$/.test(b)?escape(b).replace(/\%/g,""):b.toLowerCase().replace(/[^\w]+/g,"-");a.push(f);f="<h"+c+' id="h'+c+"-"+this.options.headerPrefix+k+'">';f=f+('<a name="'+b+'" class="reference-link"></a>')+'<span class="header-link octicon octicon-link"></span>';f+=e?this.atLink(this.emoji(d)):this.atLink(this.emoji(b));return f+="</h"+c+">"};k.pageBreak=function(a){t.test(a)&&c.pageBreak&&(a='<hr style="page-break-after:always;" class="page-break editormd-page-break" />');
        return a};k.paragraph=function(a){var b=/\$\$(.*)\$\$/g.test(a),d=/^\$\$(.*)\$\$$/.test(a),f=d?' class="'+e.classNames.tex+'"':"",k=c.tocm?/^(\[TOC\]|\[TOCM\])$/.test(a):/^\[TOC\]$/.test(a),h=/^\[TOCM\]$/.test(a);a=!d&&b?a.replace(/(\$\$([^\$]*)\$\$)+/g,function(a,b){return'<span class="'+e.classNames.tex+'">'+b.replace(/\$/g,"")+"</span>"}):d?a.replace(/\$/g,""):a;b='<div class="markdown-toc editormd-markdown-toc">'+a+"</div>";return k?h?'<div class="editormd-toc-menu">'+b+"</div><br/>":b:t.test(a)?
        this.pageBreak(a):"<p"+f+">"+this.atLink(this.emoji(a))+"</p>\n"};k.code=function(a,b,c){return"seq"===b||"sequence"===b?'<div class="sequence-diagram">'+a+"</div>":"flow"===b?'<div class="flowchart">'+a+"</div>":"math"===b||"latex"===b||"katex"===b?'<p class="'+e.classNames.tex+'">'+a+"</p>":d.Renderer.prototype.code.apply(this,arguments)};k.tablecell=function(a,b){var c=b.header?"th":"td";return(b.align?"<"+c+' style="text-align:'+b.align+'">':"<"+c+">")+this.atLink(this.emoji(a))+"</"+c+">\n"};
        k.listitem=function(a){return c.taskList&&/^\s*\[[x\s]\]\s*/.test(a)?(a=a.replace(/^\s*\[\s\]\s*/,'<input type="checkbox" class="task-list-item-checkbox" /> ').replace(/^\s*\[x\]\s*/,'<input type="checkbox" class="task-list-item-checkbox" checked disabled /> '),'<li style="list-style: none;">'+this.atLink(this.emoji(a))+"</li>"):"<li>"+this.atLink(this.emoji(a))+"</li>"};return k};e.markdownToCRenderer=function(a,b,c,d){var e="",f=0,g=this.classPrefix;d=d||1;for(var h=0,m=a.length;h<m;h++){var p=
        a[h].text,r=a[h].level;r<d||(e=r>f?e+"":r<f?e+Array(f-r+2).join("</ul></li>"):e+"</ul></li>",e+='<li><a class="toc-level-'+r+'" href="#'+p+'" level="'+r+'">'+p+"</a><ul>",f=r)}a=b.find(".markdown-toc");1>a.length&&"false"===b.attr("previewContainer")&&(a='<div class="markdown-toc '+g+'markdown-toc"></div>',b.html(c?'<div class="'+g+'toc-menu">'+a+"</div>":a),a=b.find(".markdown-toc"));c&&a.wrap('<div class="'+g+'toc-menu"></div><br/>');a.html('<ul class="markdown-toc-list"></ul>').children(".markdown-toc-list").html(e.replace(/\r?\n?\<ul\>\<\/ul\>/g,
        ""));return a};e.tocDropdownMenu=function(a,b){b=b||"Table of Contents";var c=400,d=a.find("."+this.classPrefix+"toc-menu");d.each(function(){var a=f(this),d=a.children(".markdown-toc"),e='<a href="javascript:;" class="toc-menu-btn"><i class="fa fa-angle-down"></i>'+b+"</a>",h=d.children("ul"),m=h.find("li");d.append(e);m.first().before("<li><h1>"+b+' <i class="fa fa-angle-down"></i></h1></li>');a.mouseover(function(){h.show();m.each(function(){var a=f(this),b=a.children("ul");""===b.html()&&b.remove();
        if(0<b.length&&""!==b.html()){var d=a.children("a").first();1>d.children(".fa").length&&d.append(f('<i class="fa fa-angle-down"></i>').css({float:"right",paddingTop:"4px"}))}a.mouseover(function(){b.css("z-index",c).show();c+=1}).mouseleave(function(){b.hide()})})}).mouseleave(function(){h.hide()})});return d};e.filterHTMLTags=function(a,b){"string"!==typeof a&&(a=new String(a));if("string"!==typeof b)return a;for(var c=b.split("|"),d=c[0].split(","),e=c[1],c=0,l=d.length;c<l;c++){var g=d[c];a=a.replace(new RegExp("<s*"+
        g+"s*([^>]*)>([^>]*)<s*/"+g+"s*>","igm"),"")}"undefined"!==typeof e&&(d=/\<(\w+)\s*([^\>]*)\>([^\>]*)\<\/(\w+)\>/ig,a="*"===e?a.replace(d,function(a,b,c,d,e){return"<"+b+">"+d+"</"+e+">"}):"on*"===e?a.replace(d,function(a,b,c,d,e){b=f("<"+b+">"+d+"</"+e+">");a=f(a)[0].attributes;var g={};f.each(a,function(a,b){'"'!==b.nodeName&&(g[b.nodeName]=b.nodeValue)});f.each(g,function(a){0===a.indexOf("on")&&delete g[a]});b.attr(g);a="undefined"!==typeof b[1]?f(b[1]).text():"";return b[0].outerHTML+a}):a.replace(d,
        function(a,b,c,d){var g=e.split(","),l=f(a);l.html(d);f.each(g,function(a){l.attr(g[a],null)});return l[0].outerHTML}));return a};e.markdownToHTML=function(a,b){e.$marked=marked;var c=f("#"+a),d=c.settings=f.extend(!0,{gfm:!0,toc:!0,tocm:!1,tocStartLevel:1,tocTitle:"\u76ee\u5f55",tocDropdown:!1,tocContainer:"",markdown:"",markdownSourceCode:!1,htmlDecode:!1,autoLoadKaTeX:!0,pageBreak:!0,atLink:!0,emailLink:!0,tex:!1,taskList:!1,emoji:!1,flowChart:!1,sequenceDiagram:!1,previewCodeHighlight:!0},b||
        {}),k=c.find("textarea");1>k.length&&(c.append("<textarea></textarea>"),k=c.find("textarea"));var l=""===d.markdown?k.val():d.markdown,g=[],h={renderer:e.markedRenderer(g,{toc:d.toc,tocm:d.tocm,tocStartLevel:d.tocStartLevel,taskList:d.taskList,emoji:d.emoji,tex:d.tex,pageBreak:d.pageBreak,atLink:d.atLink,emailLink:d.emailLink,flowChart:d.flowChart,sequenceDiagram:d.sequenceDiagram,previewCodeHighlight:d.previewCodeHighlight}),gfm:d.gfm,tables:!0,breaks:!0,pedantic:!1,sanitize:d.htmlDecode?!1:!0,smartLists:!0,
        smartypants:!0},l=new String(l),h=marked(l,h),h=e.filterHTMLTags(h,d.htmlDecode);d.markdownSourceCode?k.text(l):k.remove();c.addClass("markdown-body "+this.classPrefix+"html-preview").append(h);l=""!==d.tocContainer?f(d.tocContainer):c;""!==d.tocContainer&&l.attr("previewContainer",!1);d.toc&&(c.tocContainer=this.markdownToCRenderer(g,l,d.tocDropdown,d.tocStartLevel),(d.tocDropdown||0<c.find("."+this.classPrefix+"toc-menu").length)&&this.tocDropdownMenu(c,d.tocTitle),""!==d.tocContainer&&c.find(".editormd-toc-menu, .editormd-markdown-toc").remove());
        d.previewCodeHighlight&&(c.find("pre").addClass("prettyprint linenums"),prettyPrint());e.isIE8||(d.flowChart&&c.find(".flowchart").flowChart(),d.sequenceDiagram&&c.find(".sequence-diagram").sequenceDiagram({theme:"simple"}));if(d.tex){var m=function(){c.find("."+e.classNames.tex).each(function(){var a=f(this);katex.render(a.html().replace(/&lt;/g,"<").replace(/&gt;/g,">"),a[0]);a.find(".katex").css("font-size","1.6em")})};!d.autoLoadKaTeX||e.$katex||e.kaTeXLoaded?m():this.loadKaTeX(function(){e.$katex=
            katex;e.kaTeXLoaded=!0;m()})}c.getMarkdown=function(){return k.val()};return c};e.themes=["default","dark"];e.previewThemes=["default","dark"];e.editorThemes="default 3024-day 3024-night ambiance ambiance-mobile base16-dark base16-light blackboard cobalt eclipse elegant erlang-dark lesser-dark mbo mdn-like midnight monokai neat neo night paraiso-dark paraiso-light pastel-on-dark rubyblue solarized the-matrix tomorrow-night-eighties twilight vibrant-ink xq-dark xq-light".split(" ");e.loadPlugins={};
    e.loadFiles={js:[],css:[],plugin:[]};e.loadPlugin=function(a,b,c){b=b||function(){};this.loadScript(a,function(){e.loadFiles.plugin.push(a);b()},c)};e.loadCSS=function(a,b,c){c=c||"head";b=b||function(){};var d=document.createElement("link");d.type="text/css";d.rel="stylesheet";d.onload=d.onreadystatechange=function(){e.loadFiles.css.push(a);b()};d.href=a+".css";"head"===c?document.getElementsByTagName("head")[0].appendChild(d):document.body.appendChild(d)};e.isIE="Microsoft Internet Explorer"==navigator.appName;
    e.isIE8=e.isIE&&"8."==navigator.appVersion.match(/8./i);e.loadScript=function(a,b,c){c=c||"head";b=b||function(){};var d=null,d=document.createElement("script");d.id=a.replace(/[\./]+/g,"-");d.type="text/javascript";d.src=a+".js";e.isIE8?d.onreadystatechange=function(){!d.readyState||"loaded"!==d.readyState&&"complete"!==d.readyState||(d.onreadystatechange=null,e.loadFiles.js.push(a),b())}:d.onload=function(){e.loadFiles.js.push(a);b()};"head"===c?document.getElementsByTagName("head")[0].appendChild(d):
        ...
        opacity:.1},lockScreen:!0,footer:!0,buttons:!1},a);var b=this,c=this.editor,d=e.classPrefix,k=(new Date).getTime(),l=""===a.name?d+"dialog-"+k:a.name,k=e.mouseOrTouch,g='<div class="'+d+"dialog "+l+'">';""!==a.title&&(g+='<div class="'+d+'dialog-header"'+(a.drag?' style="cursor: move;"':"")+">",g+='<strong class="'+d+'dialog-title">'+a.title+"</strong>",g+="</div>");a.closed&&(g+='<a href="javascript:;" class="fa fa-close '+d+'dialog-close"></a>');g+='<div class="'+d+'dialog-container">'+a.content;
        if(a.footer||"string"===typeof a.footer)g+='<div class="'+d+'dialog-footer">'+("boolean"===typeof a.footer?"":a.footer)+"</div>";g=g+"</div>"+('<div class="'+d+"dialog-mask "+d+'dialog-mask-bg"></div>');g+='<div class="'+d+"dialog-mask "+d+'dialog-mask-con"></div>';g+="</div>";c.append(g);var h=c.find("."+l);h.lockScreen=function(c){a.lockScreen&&(f("html,body").css("overflow",c?"hidden":""),b.resize());return h};h.showMask=function(){a.mask&&c.find("."+d+"mask").css(a.maskStyle).css("z-index",e.dialogZindex-
            1).show();return h};h.hideMask=function(){a.mask&&c.find("."+d+"mask").hide();return h};h.loading=function(a){h.find("."+d+"dialog-mask")[a?"show":"hide"]();return h};h.lockScreen(!0).showMask();h.show().css({zIndex:e.dialogZindex,border:e.isIE8?"1px solid #ddd":"",width:"number"===typeof a.width?a.width+"px":a.width,height:"number"===typeof a.height?a.height+"px":a.height});l=function(){h.css({top:(c.height()-h.height())/2+"px",left:(c.width()-h.width())/2+"px"})};l();f(window).resize(l);h.children("."+
            d+"dialog-close").bind(k("click","touchend"),function(){h.hide().lockScreen(!1).hideMask()});if("object"===typeof a.buttons){var l=h.footer=h.find("."+d+"dialog-footer"),m;for(m in a.buttons){var g=a.buttons[m],p=d+m+"-btn";l.append('<button class="'+d+"btn "+p+'">'+g[0]+"</button>");g[1]=f.proxy(g[1],h);l.children("."+p).bind(k("click","touchend"),g[1])}}if(""!==a.title&&a.drag){var r,n;m=h.children("."+d+"dialog-header");a.mask||m.bind(k("click","touchend"),function(){e.dialogZindex+=2;h.css("z-index",
            e.dialogZindex)});m.mousedown(function(a){a=a||window.event;r=a.clientX-parseInt(h[0].style.left);n=a.clientY-parseInt(h[0].style.top);document.onmousemove=v});var q=function(a){a.removeClass(d+"user-unselect").off("selectstart")},t=function(a){a.addClass(d+"user-unselect").on("selectstart",function(a){return!1})},v=function(a){a=a||window.event;var b;b=parseInt(h[0].style.left);var c=parseInt(h[0].style.top);0<=b?b+h.width()<=f(window).width()?b=a.clientX-r:(b=f(window).width()-h.width(),document.onmousemove=
            null):(b=0,document.onmousemove=null);0<=c?a=a.clientY-n:(a=0,document.onmousemove=null);document.onselectstart=function(){return!1};t(f("body"));t(h);h[0].style.left=b+"px";h[0].style.top=a+"px"};document.onmouseup=function(){q(f("body"));q(h);document.onselectstart=null;document.onmousemove=null};m.touchDraggable=function(){var a=null;this.bind("touchstart",function(b){b=b.originalEvent;var c=f(this).parent().position();a={x:b.changedTouches[0].pageX-c.left,y:b.changedTouches[0].pageY-c.top}}).bind("touchmove",
            function(b){b.preventDefault();b=b.originalEvent;f(this).parent().css({top:b.changedTouches[0].pageY-a.y,left:b.changedTouches[0].pageX-a.x})})};m.touchDraggable()}e.dialogZindex+=2;return h};e.mouseOrTouch=function(a,b){b=b||"touchend";var c=a||"click";try{document.createEvent("TouchEvent"),c=b}catch(d){}return c};e.dateFormat=function(a){a=a||"";var b=function(a){return 10>a?"0"+a:a},c=new Date,d=c.getFullYear(),e=d.toString().slice(2,4),f=b(c.getMonth()+1),g=b(c.getDate()),h=c.getDay(),m=b(c.getHours()),
        p=b(c.getMinutes()),r=b(c.getSeconds()),b=b(c.getMilliseconds()),n="",n=e+"-"+f+"-"+g,q=d+"-"+f+"-"+g,t=m+":"+p+":"+r;switch(a){case "UNIX Time":n=c.getTime();break;case "UTC":n=c.toUTCString();break;case "yy":n=e;break;case "year":case "yyyy":n=d;break;case "month":case "mm":n=f;break;case "cn-week-day":case "cn-wd":n="\u661f\u671f"+"\u65e5\u4e00\u4e8c\u4e09\u56db\u4e94\u516d".split("")[h];break;case "week-day":case "wd":n="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")[h];
        break;case "day":case "dd":n=g;break;case "hour":case "hh":n=m;break;case "min":case "ii":n=p;break;case "second":case "ss":n=r;break;case "ms":n=b;break;case "yy-mm-dd":break;case "yyyy-mm-dd":n=q;break;case "yyyy-mm-dd h:i:s ms":case "full + ms":n=q+" "+t+" "+b;break;default:n=q+" "+t}return n};return e}});