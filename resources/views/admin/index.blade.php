        ...
        <div class="admin-content-body">
            ...
            <div class="am-g">
                <div class="am-u-md-6">
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-2'}">会员分布<span
                                    class="am-icon-chevron-down am-fr"></span></div>
                ...
                <div class="am-u-md-6">
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-3'}">站点会员男女比例统计<span
                                    class="am-icon-chevron-down am-fr"></span></div>
                        <div class="am-panel-bd am-collapse am-in am-cf" id="collapse-panel-3">

                            <div id="sex_kind" style="width: 600px;height:400px;"></div>
...
@section('js')
    <script src="/vendor/echart/echarts.min.js"></script>
    <script src="/vendor/echart/roma.js"></script>
    <script src="/vendor/echart/china.js"></script>
    <script type="text/javascript">

        // 基于准备好的dom，初始化echarts实例
        $.getJSON('http://shop.dev/api/map', function (data) {
            console.log(data);
        ...
        $.getJSON('http://shop.dev/api/sex_kind', function (data) {
            console.log(data);

            // 基于准备好的dom，初始化echarts实例
            var myChart = echarts.init(document.getElementById('sex_kind'), 'roma');
